...
void setup() {
  ...
  paint.Clear(COLORED); 
  paint.DrawStringAt(5, 10, "D3", &Font20, UNCOLORED); // 사각형 안에서의 글씨 위치
  ...
  paint.Clear(COLORED); 
  paint.DrawStringAt(5, 10, "Absence", &Font20, UNCOLORED); // 사각형 안에서의 글씨 위치
  ...
  paint.Clear(COLORED); 
  paint.DrawStringAt(5, 10, "Christopher", &Font24, UNCOLORED); // 사각형 안에서의 글씨 위치
