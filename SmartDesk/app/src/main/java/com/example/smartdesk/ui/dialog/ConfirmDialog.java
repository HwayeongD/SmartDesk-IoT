...
public class CustomDialog extends Dialog implements View.OnClickListener {
    ...
    public CustomDialog(Context context, int dImgResource, String dTitle, String dContent, String okBtn) {
        super(context);
    ...
    public CustomDialog(Context context, int dImgResource, String dTitle, String dContent, String okBtn, String noBtn) {
        super(context);
